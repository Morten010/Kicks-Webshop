...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors hover:bg-brand-blue/20 data-[state=selected]:bg-slate-100 ",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle font-medium text-black [&:has([role=checkbox])]:pr-0 dark:text-black",
      className
    )}
    {...props}
  />
